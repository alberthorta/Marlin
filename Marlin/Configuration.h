...
#define STRING_CONFIG_H_AUTHOR "(Albert Horta Llobet, SW X1 BLTOUCH + HEMERA + SGEN L v1)" // Who made the changes.
...
#define MACHINE_UUID "7ac4f5b5-3dc2-4e2b-a468-5c3f2c3f91d4"
...
#define TEMP_SENSOR_BED 1 // Default Hot Bed Artillery Sensor
 ...
 */
#define Z_MIN_PROBE_PIN P1_24 // We will be using pin 19 (Z-MAX pin) for the probe
...
#define NOZZLE_TO_PROBE_OFFSET { 0, 28, -2.05 }
...
#define HOMING_FEEDRATE_MM_M { (60*60), (60*60), (16*60) }
